  ...
  return (
    <div className='flex justify-center items-center p-10 min-h-[600px] w-full bg-white'>
      <div className='flex flex-col md:flex-row items-center justify-center h-full'>
        <StaticImage src="../images/teamwork.webp" className='w-[260px] sm:w-[300px] lg:w-auto' placeholder='blurred' quality={100} />
        <div className='w-full md:w-[48%] md:ml-14'>
          <div className='text-[32px] md:text-[54px] text-center md:leading-[56px] mb-4'>
